...
public class ExtraHealthEffectTest {
    ExtraHealthEffect effect;
    Player target;
    ...
    public void setUp() {
        ...
        effect = new ExtraHealthEffect(1, false, 3, 3, target);
    }

    @Test
    public void testApplyEffect() {
        effect.applyEffect();
        assertEquals(101, target.getMaxHealth());
    }
    ...
    public void testRemoveEffect() {
        effect.applyEffect();
        effect.removeEffect();
        assertEquals(100, target.getMaxHealth());
    }
