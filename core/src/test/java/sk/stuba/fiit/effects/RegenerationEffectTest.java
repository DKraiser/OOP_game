...
public class RegenerationEffectTest {
    RegenerationEffect effect;
    Player target;
    ...
    public void setUp() {
        ...
        target = new Player("TestPlayer", "Test Desc", null, 10f, new Vector2(50, 50), 50, 100, 10, new Timer(2), 0, weaponFactory);
        effect = new RegenerationEffect(1, false, 3, 3, target);
    }

    @Test
    public void testApplyEffect() {
        effect.applyEffect();
        assertEquals(1, target.getHealingTimer().getPeriod());
    }
    ...
    public void testRemoveEffect() {
        effect.applyEffect();
        effect.removeEffect();
        assertEquals(2, target.getHealingTimer().getPeriod());
    }
