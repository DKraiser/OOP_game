...
public class ParalyseEffectTest {
    ParalyseEffect effect;
    Player target;
    ...
    public void setUp() {
        ...
        effect = new ParalyseEffect(false, 3, target);
    }

    @Test
    public void testApplyEffect() {
        effect.applyEffect();
        assertFalse(target.getAttackStrategy() instanceof TargetRangedAttackingStrategy);
    }
    ...
    public void testRemoveEffect() {
        effect.applyEffect();
        effect.removeEffect();
        assertInstanceOf(DirectionRangedAttackingStrategy.class, target.getAttackStrategy());
    }
